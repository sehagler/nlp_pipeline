...
class Postprocessing_manager(object):
    ...
    def __init__(self, static_data_manager, metadata_manager):
        self.project_data = static_data_manager.get_project_data()
        self.output_manager = Output_manager(self.project_data, 
                                             metadata_manager)
    ...
    def import_reports(self):
        self._import_reports_body(self.project_data)
    ...
    def set_data_dirs(self):
        directory_manager = self.project_data['directory_manager']
