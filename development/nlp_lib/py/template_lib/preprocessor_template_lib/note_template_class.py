...
#
class Note_template(Preprocessor_base):
    ...
    def _extract_section_headers(self):
        ...
        section_header_normalizer.allergies('unformatted')
        section_header_normalizer.assessment('unformatted')
        #section_header_normalizer.comment('unformatted')
        section_header_normalizer.datetime('unformatted')
        section_header_normalizer.diagnosis('unformatted')
        section_header_normalizer.evaluation('unformatted')
        section_header_normalizer.goals('unformatted')
        section_header_normalizer.history('unformatted')
        section_header_normalizer.hospital_course('unformatted')
        section_header_normalizer.icd9('unformatted')
        section_header_normalizer.impression_and_recommendation('unformatted')
        section_header_normalizer.insurance('unformatted')
        section_header_normalizer.intervention('unformatted')
        section_header_normalizer.lab_test_and_medication('unformatted')
        section_header_normalizer.objective('unformatted')
        section_header_normalizer.other('unformatted')
        section_header_normalizer.person('unformatted')
        section_header_normalizer.reason('unformatted')
        section_header_normalizer.service('unformatted')
        section_header_normalizer.subjective('unformatted')
        section_header_normalizer.technique('unformatted')
        section_header_normalizer.twenty_four_hour_events('unformatted')
