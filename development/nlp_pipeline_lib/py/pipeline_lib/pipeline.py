...
#
from nlp_pipeline_lib.py.process_lib.process_manager_class import Process_manager
from nlp_pipeline_lib.py.software_lib.software_manager_class import Software_manager
...
class Pipeline(object):
    ...
    def linguamatics_i2e_postqueries(self, project_subdir):
        ...
        self.process_manager.ohsu_nlp_templates_run_templates()
    ...
    #
    def ohsu_nlp_templates_train_templates(self, password, project_subdir,
                                           start_idx=0, cleanup_flg=True):
        if start_idx >= 0:
            '''
            if start_idx > 0:
