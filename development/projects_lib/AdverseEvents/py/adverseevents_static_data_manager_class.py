...
class AdverseEvents_static_data_manager(Static_data_manager):
    ...
    def __init__(self, operation_mode, project_subdir, user, root_dir_flg):
        ...
        if self.project_subdir == 'test':
            ...
            self.static_data['raw_data_files']['Schuff_Hagler_AE_NLP_HNO_Notes.xml']['DATETIME_FORMAT'] = '%d-%b-%y'
            self.static_data['raw_data_files']['Schuff_Hagler_AE_NLP_HNO_Notes.xml']['ENCODING'] = 'utf-8'
