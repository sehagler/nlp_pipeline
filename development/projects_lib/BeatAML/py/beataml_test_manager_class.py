...
from projects_lib.BeatAML.py.beataml_project_manager_class import BeatAML_project_manager
from projects_lib.BeatAML.py.data_validation_class import Data_validation

#
class BeatAML_test_manager(Test_manager):
    
    #
    def __init__(self, project_data, root_dir_flg):
        user = project_data['user']
        project_manager_development = BeatAML_project_manager('development', user, root_dir_flg)
        project_manager_production = BeatAML_project_manager('production', user, root_dir_flg)
