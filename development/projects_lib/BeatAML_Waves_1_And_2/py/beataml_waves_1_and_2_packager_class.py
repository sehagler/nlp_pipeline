...
from projects_lib.BeatAML_Waves_1_And_2.py.project_lib.packaging_jsons_class \
    import Packaging_jsons

#
class BeatAML_Waves_1_And_2_packager(Packaging_jsons):
    ...
    def __init__(self, jsons_in_dir, directory_manager):
        ...
        Packaging_jsons.__init__(self, jsons_in_dir, directory_manager)
    ...
    def _read_data(self):
        data_json = {}
        for json_file in os.listdir(self.jsons_in_dir):
            json_tmp = read_json_file(os.path.join(self.jsons_in_dir, json_file))
