...
class Gold_standard_jsons(Specimens_base):
    ...
    def __init__(self, directory_manager, mrn_list):
        self.deidentifier_xlsx = \
            directory_manager.pull_directory('raw_data_dir') + '/manuscript OHSU MRNs.xlsx'
        self.gpld_standard_xlsx = \
            directory_manager.pull_directory('raw_data_dir') + '/Sup Table 5 Clinical summary.xlsx'
