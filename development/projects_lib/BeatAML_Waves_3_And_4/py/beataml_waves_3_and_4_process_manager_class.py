...
from projects_lib.BeatAML_Waves_3_And_4.py.cytogenetics_report_preprocessor_class \
    import Cytogenetics_report_preprocessor
from projects_lib.BeatAML_Waves_3_And_4.py.hematopathology_report_preprocessor_class \
    import Hematopathology_report_preprocessor
from projects_lib.BeatAML_Waves_3_And_4.py.beataml_waves_3_and_4_report_preprocessor_class \
    import BeatAML_Waves_3_And_4_report_preprocessor

#
class BeatAML_Waves_3_And_4_process_manager(Process_manager):
    
    #
    def __init__(self, project_data, server):
        Process_manager.__init__(self, project_data, server)
        self.beataml_report_preprocessor = BeatAML_Waves_3_And_4_report_preprocessor(project_data, 'formatted')
