...
class BeatAML_Waves_3_And_4_project_manager(Project_manager):
    ...
    def get_project_data(self):
        ...
        self.project_data['raw_data_files']['PowerPath_Chromosome_Reports.xlsx']['NLP_MODE'] = 'RESULT_ID'
        ...
        self.project_data['raw_data_files']['PowerPath_Hematopathology_Reports.xlsx']['NLP_MODE'] = 'CASE_NUMBER'
        ...
        self.project_data['patient_list'] = patients[1:]
