...
from projects_lib.BeatAML_Waves_3_And_4.py.beataml_waves_3_and_4_packager_class \
    import BeatAML_Waves_3_And_4_packager
from projects_lib.BeatAML_Waves_3_And_4.py.gold_standard_jsons_class import Gold_standard_jsons
from projects_lib.BeatAML_Waves_3_And_4.py.project_lib.packaging_base_class import Packaging_base
...
class Data_validation(Packaging_base):
    ...
    def _get_data(self):
        ...
        validation_object = BeatAML_Waves_3_And_4_packager(self.data_dir, self.directory_manager)
