...
from nlp_lib.py.processor_lib.preprocessor_lib.rewriters_lib.normalizers_lib.table_normalizer_class \
...
from nlp_lib.py.tool_lib.query_tools_lib.antigens_tools import Posttokenizer as Posttokenizer_antigens
