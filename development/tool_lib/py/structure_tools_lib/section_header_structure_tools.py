...
class Section_header_structure_tools(object):
    ...
    def _section_header_dict(self):
        ...
        section_header_dict['ALLERGIES'] = regex_dict
        regex_list = []
        regex_list.append('(?i)\n' + article() + ' ([a-z]+ )?' + amend() + \
                          ' ' +  '(' + be() + '|reports)')
        regex_list.append('(?i)\n' + article() + ' ' + review_item() + \
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['BACKGROUND'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['CYTOGENETIC ANALYSIS SUMMARY'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('cytochemical stain' + s())
        regex_list.append('cytogenetic and fish studies')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['CYTOGENETIC AND FISH STUDIES'] = regex_dict
        regex_dict
        regex_list = []
        ...
        section_header_dict['DATETIME'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['EXPLANATION'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('((brief|past) )?' + '(family history|FH)')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['FAMILY HISTORY'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['FLOW CYTOMETRIC ANALYSIS'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('goals')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['GOALS'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('hospital course')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['HOSPITAL COURSE'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('(' + diagnosis() + '/)?icd-9')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['ICD-9'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('(microscopic description/)?immunohistochemi(cal stain' + s() + '|stry)')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['IMMUNOHISTOCHEMICAL STAINS'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('immunologic analysis')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['IMMUNOLOGIC ANALYSIS'] = regex_dict
        regex_dict = {}
        text_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['INSURANCE'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['INTERVENTION'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['LAB DATA'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append(medication() + ' and lab(oratory)? tests')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['LAB DATA AND MEDICATION'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['MEDICATION'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('method' + s())
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['METHOD'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('molecular studies')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['MOLECULAR STUDIES'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['OBJECTIVE'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('modules accepted')
        regex_list.append('read back done')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['OTHER'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['PREAMENDMENT DIAGNOSIS'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['REASON'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['SERVICE'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('special stain' + s())
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['SPECIAL STAINS'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['SUBJECTIVE'] = regex_dict
        regex_dict = {}
        regex_list = []
        regex_list.append('surgical pathology summary')
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['SURGICAL PATHOLOGY SUMMARY'] = regex_dict
        regex_dict = {}
        regex_list = []
        ...
        regex_dict['ADD PRE_PUNCT AND POST_PUNCT'] = regex_list
        section_header_dict['TWENTY-FOUR HOUR EVENTS'] = regex_dict
