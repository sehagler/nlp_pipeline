...
class Postprocessor(Postprocessor_base):
    ...
    #
    def __init__(self, csv_file, data_key_map, data_value_map, label, diagnosis_reader):
        Postprocessor_base.__init__(self, label, csv_file, data_key_map, data_value_map)
