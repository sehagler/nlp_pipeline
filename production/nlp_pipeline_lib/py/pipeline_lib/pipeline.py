...
#
from nlp_pipeline_lib.py.process_lib.process_manager_class \
    import Process_manager
from nlp_pipeline_lib.py.registry_lib.remote_manager_registry_class \
    import Remote_manager_registry
from nlp_pipeline_lib.py.software_lib.software_manager_class \
