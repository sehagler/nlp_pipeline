...
from nlp_lib.py.tool_lib.query_tools_lib.antigens_tools import Postprocessor as Postprocessor_antigens
from nlp_lib.py.tool_lib.query_tools_lib.blasts_tools import Postprocessor as Postprocessor_blasts
from nlp_lib.py.tool_lib.query_tools_lib.date_tools import Postprocessor as Postprocessor_date
from nlp_lib.py.tool_lib.query_tools_lib.diagnosis_tools import Postprocessor as Postprocessor_diagnosis
from nlp_lib.py.tool_lib.query_tools_lib.fab_classification_tools import Postprocessor as Postprocessor_fab_classification
from nlp_lib.py.tool_lib.query_tools_lib.fish_analysis_summary_tools import Postprocessor as Postprocessor_fish_analysis_summary
from nlp_lib.py.tool_lib.query_tools_lib.immunophenotype_tools import Postprocessor as Postprocessor_immunophenotype
from nlp_lib.py.tool_lib.query_tools_lib.karyotype_tools import Postprocessor as Postprocessor_karyotype
from nlp_lib.py.tool_lib.query_tools_lib.specific_diagnosis_tools import Postprocessor as Postprocessor_specific_diagnosis
from projects_lib.BeatAML.py.diagnosis_reader_class import Diagnosis_reader

#
class BeatAML_postprocessor(Postprocessor):
    ...
    def _import_reports_body(self, project_data):
        ...
        self.output_manager.append(Postprocessor_base(os.path.join(data_dir, 'extramedullary_disease.csv'),
        ...
        self.output_manager.append(Postprocessor_base(os.path.join(data_dir, 'residual_disease.csv'),
                                                       data_key_map, data_value_map, None))
