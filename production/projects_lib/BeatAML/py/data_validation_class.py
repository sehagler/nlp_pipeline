...
from projects_lib.BeatAML.py.beataml_packager_class import BeatAML_packager
from projects_lib.BeatAML.py.gold_standard_jsons_class import Gold_standard_jsons
from projects_lib.BeatAML.py.project_lib.packaging_base_class import Packaging_base
...
class Data_validation(Packaging_base):
    ...
    def _get_data(self):
        ...
        validation_object = BeatAML_packager(self.data_dir, self.directory_manager)
