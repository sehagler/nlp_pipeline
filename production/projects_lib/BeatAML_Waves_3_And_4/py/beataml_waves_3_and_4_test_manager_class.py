...
class BeatAML_Waves_3_And_4_test_manager(Test_manager):
    ...
    def __init__(self, project_data, root_dir_flg):
        ...
        project_manager_development = \
            BeatAML_Waves_3_And_4_project_manager('development', project_subdir, user, root_dir_flg)
        project_manager_production = \
            BeatAML_Waves_3_And_4_project_manager('production', project_subdir, user, root_dir_flg)
