...
class CCC19_static_data_manager(Static_data_manager):
    ...
    def __init__(self, operation_mode, user, root_dir_flg, project_subdir=None):
        ...
        if self.project_subdir == 'production':
            ...
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_HNO_NOTE_20220906_113714.XML']['DATETIME_FORMAT'] = '%Y-%m-%d %H:%M:%S'
            ...
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_HNO_NOTE_20220906_115047.XML']['DATETIME_FORMAT'] = '%Y-%m-%d %H:%M:%S'
            ...
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_HNO_NOTE_20220906_120437.XML']['DATETIME_FORMAT'] = '%Y-%m-%d %H:%M:%S'
            ...
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_HNO_NOTE_20220906_121817.XML']['DATETIME_FORMAT'] = '%Y-%m-%d %H:%M:%S'
            ...
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_HNO_NOTE_20220906_123247.XML']['DATETIME_FORMAT'] = '%Y-%m-%d %H:%M:%S'
            ...
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_PATH_RESULTS_20220906_113701.XML']['DATETIME_FORMAT'] = '%Y-%m-%d %H:%M:%S'
            self.static_data['raw_data_files']['NAGLE_CCC19_NLP_PATH_RESULTS_20220906_113701.XML']['DATETIME_KEY'] = 'SPECIMEN_COLLECTED_DATE'
